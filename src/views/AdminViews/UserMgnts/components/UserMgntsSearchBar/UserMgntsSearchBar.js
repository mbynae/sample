								...
								<MC.Grid container spacing={2}>
									<MC.Grid item xs={12} md={4}>
										<MC.FormControl fullWidth className={classes.formControl}>
											<MC.InputLabel id="userDataType.residentsType-label">상태</MC.InputLabel>
											<MC.Select
												...
												<MC.MenuItem value={"AWAITING_RESIDENTS"}>승인대기</MC.MenuItem>
												<MC.MenuItem value={"RESIDENTS"}>입주민</MC.MenuItem>
											</MC.Select>
										</MC.FormControl>
									</MC.Grid>
									<MC.Grid item xs={12} md={4}>
										<MC.FormControl fullWidth className={classes.formControl}>
											<MC.InputLabel id="userDataType.ownerType-label">소유주여부</MC.InputLabel>
											<MC.Select
									...
									<MC.Grid item xs={12} md={4}>
										<MC.FormControl fullWidth className={classes.formControl}>
											...
											<MC.RadioGroup
												...
												<MC.FormControlLabel value="HOUSEHOLD_OWNER" control={<MC.Radio />} label="세대주" />
												<MC.FormControlLabel value="HOUSEHOLD_MEMBER" control={<MC.Radio />} label="세대원" />
											</MC.RadioGroup>
										</MC.FormControl>
									</MC.Grid>
								</MC.Grid>
